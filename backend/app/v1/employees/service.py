...
class EmployeeService:
    ...
    async def _create_single_employee(
        ...
        emp_model = EmployeeModel(
            ...
            pf_applicable=data.get("pf_applicable", False),
            uan_number=data.get("uan_number") if data.get("pf_applicable") else None,
            esi_applicable=data.get("esi_applicable", False),
            esic_number=data.get("esic_number") if data.get("esi_applicable") else None,
